...
let elem = document.querySelectorAll(".CustomSlideBox");
for ( var i = 0; i < elem.length; i++ ) {
  var e = elem[i];
  var autoplay = elem[i].getAttribute('data-autoplay');
...
function formopen(formopen){
  ...
  var popup = document.createElement('div');
    ...
    message.innerHTML = document.getElementById("news-box").innerHTML;
